...
DataNameWOtimestamp <- paste0("Experiment_Multivariate_VaryingConfounding_CountErrorModels_nSim_",paste0(nSim,collapse="_"),"_nObsPerSim_",paste0(nObsPerSim,collapse="_"),"_nModel_",length(nModel),"_")
...
file.copy(from="Experiment_Multivariate_VaryingConfounding_CountErrorModels.R", to=paste0("Data/Log/",DataNameWOtimestamp,timestamp,".R"), overwrite = TRUE, copy.mode = TRUE, copy.date = FALSE)
