...
DataNameWOtimestamp <- paste0("Experiment_Multivariate_VaryingConfounding_Beta-11_PULSE05_nSim_",paste0(nSim,collapse="_"),"_nObsPerSim_",paste0(nObsPerSim,collapse="_"),"_nModel_",length(nModel),"_")
...
file.copy(from="Experiment_Multivariate_VaryingConfounding_Beta-11_PULSE05.R", to=paste0("Data/Log/",DataNameWOtimestamp,timestamp,".R"), overwrite = TRUE, copy.mode = TRUE, copy.date = FALSE)
